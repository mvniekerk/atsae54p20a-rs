...
use crate::target_device::port::{PINCFG1_, PMUX1_, PINCFG2_, PMUX2_, PINCFG3_, PMUX3_};
...
impl Port {
    ...
    fn dirset2(&mut self) -> &DIRSET { unsafe { &(*PORT::ptr()).dirset2 } }
    fn dirclr2(&mut self) -> &DIRCLR { unsafe { &(*PORT::ptr()).dirclr2 } }
    fn pincfg2(&mut self) -> &[PINCFG2_; 32] { unsafe { &(*PORT::ptr()).pincfg2_ } }
    fn outset2(&mut self) -> &OUTSET { unsafe { &(*PORT::ptr()).outset2 } }
    fn outclr2(&mut self) -> &OUTCLR { unsafe { &(*PORT::ptr()).outclr2 } }
    fn pmux2(&mut self) -> &[PMUX2_; 16] { unsafe { &(*PORT::ptr()).pmux2_ } }

    fn dirset3(&mut self) -> &DIRSET { unsafe { &(*PORT::ptr()).dirset3 } }
    fn dirclr3(&mut self) -> &DIRCLR { unsafe { &(*PORT::ptr()).dirclr3 } }
    fn pincfg3(&mut self) -> &[PINCFG3_; 32] { unsafe { &(*PORT::ptr()).pincfg3_ } }
    fn outset3(&mut self) -> &OUTSET { unsafe { &(*PORT::ptr()).outset3 } }
    fn outclr3(&mut self) -> &OUTCLR { unsafe { &(*PORT::ptr()).outclr3 } }
    fn pmux3(&mut self) -> &[PMUX3_; 16] { unsafe { &(*PORT::ptr()).pmux3_ } }
}
